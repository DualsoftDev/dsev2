...
|TxGuid         |"https://dualsoft.com/aas/apiDef/txGuid"         |string      |송신 Work의 GUID 참조     |0..1
|RxGuid         |"https://dualsoft.com/aas/apiDef/rxGuid"         |string      |수신 Work의 GUID 참조     |0..1
|===
...
|Motion      |"https://dualsoft.com/aas/work/motion"    |string      |모션 정의             |0..1
|Script      |"https://dualsoft.com/aas/work/script"    |string      |스크립트 정의         |0..1
...
|Status      |"https://dualsoft.com/aas/common/status"    |string      |작업 상태             |0..1
|===
...
|Status               |"https://dualsoft.com/aas/common/status"          |string      |호출 상태                     |0..1
|===
