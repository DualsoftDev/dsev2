...
[listing]
46, Gongdan-ro 140beon-gil, Gunpo-si, Gyeonggi-do, Suite 510
https://dualsoft.com
...
|08.28.2025       |1.1               |Add properties of ApiDef, ApiCall, etc.
|===
...
The Sequence Control Submodel uses standardized semantic URLs for AAS serialization. These URLs follow a consistent pattern to ensure interoperability:

==== Base Pattern
`https://dualsoft.com/aas/{category}/{element}`
...
|unique     |Unique identifiers (name, guid, id)
|plural     |Collection elements (systems, flows, works, calls)
|singular   |Single reference elements (apiDef, flow)
|common     |Common properties shared across types (status, dateTime)
|project    |Project-specific properties
|system     |System-specific properties
|work       |Work-specific properties
|call       |Call-specific properties
|apiDef     |API definition properties
|apiCall    |API call properties
|arrow      |Arrow connection properties
|===

==== Examples
- `https://dualsoft.com/aas/unique/name` - Name identifier
- `https://dualsoft.com/aas/unique/guid` - GUID identifier
- `https://dualsoft.com/aas/plural/systems` - Systems collection
- `https://dualsoft.com/aas/work/period` - Work period property
- `https://dualsoft.com/aas/apiDef/isPush` - API push property
...
└── Project
    ...
    └── PassiveSystems (0..1)
        └── System (1..*)
            └── **System structure is the same as System included in Active system**
----
...
- **Button.FlowGuid** → references **Flow.Guid**
- **Lamp.FlowGuid** → references **Flow.Guid**
- **Condition.FlowGuid** → references **Flow.Guid**
- **Action.FlowGuid** → references **Flow.Guid**
...
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |Project name                    |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Project unique identifier       |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Project table PK ID in DB       |0..1
|Author           |"https://dualsoft.com/aas/system/author"         |string      |Project last modifier           |0..1
|DateTime         |"https://dualsoft.com/aas/system/dateTime"       |dateTime    |Project last modification date  |0..1
|Version          |"https://dualsoft.com/aas/project/version"       |string      |Project version                 |0..1

|ActiveSystems    |"https://dualsoft.com/aas/plural/activeSystems"  |SMC         |Active systems                  |0..1
|PassiveSystems   |"https://dualsoft.com/aas/plural/passiveSystems" |SMC         |Passive systems collection      |0..1
...
|*category*      |PARAMETER
|*description*   |List of systems directly controlled by CPU
|===

[#_systems]
==== System
System is a structural unit that interfaces with external systems through APIs, divided into ActiveSystems controlled by CPU and PassiveSystems with device characteristics controlled by natural laws.
The System includes the System structure defined in <<_element_hierarchy>>.
[width="100%",cols="10%,40%,10%,25%,15%",options="header",]
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                   |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |System name                     |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |System unique identifier        |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |System table PK ID in DB        |0..1
|Author           |"https://dualsoft.com/aas/system/author"         |string      |System last modifier            |0..1
|DateTime         |"https://dualsoft.com/aas/system/dateTime"       |dateTime    |System last modification date   |0..1
|EngineVersion    |"https://dualsoft.com/aas/system/engineVersion"  |string      |DS engine version               |0..1
|LangVersion      |"https://dualsoft.com/aas/system/langVersion"    |string      |DS language version             |0..1
|Flows            |"https://dualsoft.com/aas/plural/flows"          |SMC         |Sub flows collection            |0..1
|Works            |"https://dualsoft.com/aas/plural/works"          |SMC         |Sub works collection            |0..1
|ApiDefs          |"https://dualsoft.com/aas/plural/apiDefs"        |SMC         |Sub ApiDefs collection          |0..1
|ApiCalls         |"https://dualsoft.com/aas/plural/apiCalls"       |SMC         |Sub ApiCalls collection         |0..1
|Buttons          |"https://dualsoft.com/aas/plural/buttons"        |SMC         |Sub buttons collection          |0..1
|Lamps            |"https://dualsoft.com/aas/plural/lamps"          |SMC         |Sub lamps collection            |0..1
|Conditions       |"https://dualsoft.com/aas/plural/conditions"     |SMC         |Sub conditions collection       |0..1
|Actions          |"https://dualsoft.com/aas/plural/actions"        |SMC         |Sub actions collection          |0..1
|===
...
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |API definition name                  |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |API definition unique identifier     |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |ApiDef PK ID in DB                   |0..1
|IsPush           |"https://dualsoft.com/aas/apiDef/isPush"         |boolean     |Whether API is push type             |0..1
|TxGuid           |"https://dualsoft.com/aas/apiDef/txGuid"         |string      |GUID reference to transmitting Work  |0..1
|RxGuid           |"https://dualsoft.com/aas/apiDef/rxGuid"         |string      |GUID reference to receiving Work     |0..1
|===
...
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |API call name                        |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |API call unique identifier           |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |ApiCall PK ID in DB                  |0..1
|ApiDef           |"https://dualsoft.com/aas/singular/apiDef"       |string      |GUID of ApiDef to use                |1
|InAddress        |"https://dualsoft.com/aas/apiCall/inAddress"     |string      |Input address to use for API call    |0..1
|OutAddress       |"https://dualsoft.com/aas/apiCall/outAddress"    |string      |Output address to use for API call   |0..1
|InSymbol         |"https://dualsoft.com/aas/apiCall/inSymbol"      |string      |Input symbol definition              |0..1
|OutSymbol        |"https://dualsoft.com/aas/apiCall/outSymbol"     |string      |Output symbol definition             |0..1
|ValueSpec        |"https://dualsoft.com/aas/apiCall/valueSpec"     |string      |Value specification for call         |0..1
|===
...
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |Flow name                            |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Flow unique identifier               |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Flow PK ID in DB                     |0..1
|===
...
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |Button name                          |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Button unique identifier             |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Button PK ID in DB                   |0..1
|FlowGuid         |"https://dualsoft.com/aas/button/flowGuid"       |string      |GUID of associated flow              |0..1
|===
...
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |Lamp name                            |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Lamp unique identifier               |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Lamp PK ID in DB                     |0..1
|FlowGuid         |"https://dualsoft.com/aas/lamp/flowGuid"         |string      |GUID of associated flow              |0..1
|===
...
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |Condition name                       |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Condition unique identifier          |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Condition PK ID in DB                |0..1
|FlowGuid         |"https://dualsoft.com/aas/condition/flowGuid"    |string      |GUID of associated flow              |0..1
|===
...
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |Action name                          |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Action unique identifier             |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Action PK ID in DB                   |0..1
|FlowGuid         |"https://dualsoft.com/aas/action/flowGuid"       |string      |GUID of associated flow              |0..1
|===
...
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |Work name                            |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Work unique identifier               |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Work PK ID in DB                     |0..1
|FlowGuid         |"https://dualsoft.com/aas/work/flowGuid"         |string      |GUID of parent flow                  |0..1
|Motion           |"https://dualsoft.com/aas/work/motion"           |string      |Motion definition                    |0..1
|Script           |"https://dualsoft.com/aas/work/script"           |string      |Script definition                    |0..1
|IsFinished       |"https://dualsoft.com/aas/work/isFinished"       |boolean     |Completion status                    |0..1
|NumRepeat        |"https://dualsoft.com/aas/work/numRepeat"        |integer     |Number of repetitions                |0..1
|Period           |"https://dualsoft.com/aas/work/period"           |double      |Period setting                       |0..1
|Delay            |"https://dualsoft.com/aas/work/delay"            |double      |Delay setting                        |0..1
|Status           |"https://dualsoft.com/aas/common/status"         |string      |Work status                          |0..1
|===
...
|===
|*idShort*            |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name                 |"https://dualsoft.com/aas/unique/name"           |string      |Call name                            |1
|Guid                 |"https://dualsoft.com/aas/unique/guid"           |string      |Call unique identifier               |1
|Id                   |"https://dualsoft.com/aas/unique/id"             |integer     |Call PK ID in DB                     |0..1
|CallType             |"https://dualsoft.com/aas/call/callType"         |string      |Call type                            |0..1
|ApiCalls             |"https://dualsoft.com/aas/plural/apiCalls"       |string[]    |List of ApiCall GUIDs to invoke      |0..1
|IsDisabled           |"https://dualsoft.com/aas/call/isDisabled"       |boolean     |Disabled status                      |0..1
|CommonPrecondition   |"https://dualsoft.com/aas/call/commonConditions" |string      |Common precondition                  |0..1
|AutoPrecondition     |"https://dualsoft.com/aas/call/autoConditions"   |string      |Automatic precondition               |0..1
|Timeout              |"https://dualsoft.com/aas/call/timeout"          |double      |Timeout setting                      |0..1
|Status               |"https://dualsoft.com/aas/common/status"         |string      |Call status                          |0..1
|===

===== Arrows (Call Level)

===== Arrow
Arrow representing connections between Calls, defining causal relationships between connected Calls through Source and Target.
Type represents the causal type of the arrow, including start causality and reset causality.
Source and Target represent the GUIDs of the start and end Calls connected by the arrow.
[width="100%",cols="10%,40%,10%,25%,15%",options="header",]
|===
|*idShort*        |*semanticId*                                     |*valueType* |*description*                        |*multiplicity*
|Name             |"https://dualsoft.com/aas/unique/name"           |string      |Arrow name                           |1
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Arrow unique identifier              |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Arrow PK ID in DB                    |0..1
|Source           |"https://dualsoft.com/aas/arrow/source"          |string      |Source Call GUID                     |1
|Target           |"https://dualsoft.com/aas/arrow/target"          |string      |Target Call GUID                     |1
|Type             |"https://dualsoft.com/aas/arrow/type"            |string      |Arrow causal type                    |0..1
|===

===== Arrows (Work Level)

===== Arrow
Arrow representing connections between Works, defining causal relationships between connected Works through Source and Target.
Type represents the causal type of the arrow, including start causality and reset causality.
Source and Target represent the GUIDs of the start and end Works connected by the arrow.
...
|Guid             |"https://dualsoft.com/aas/unique/guid"           |string      |Arrow unique identifier              |1
|Id               |"https://dualsoft.com/aas/unique/id"             |integer     |Arrow PK ID in DB                    |0..1
|Source           |"https://dualsoft.com/aas/arrow/source"          |string      |Source Work GUID                     |1
|Target           |"https://dualsoft.com/aas/arrow/target"          |string      |Target Work GUID                     |1
|Type             |"https://dualsoft.com/aas/arrow/type"            |string      |Arrow causal type                    |0..1
|===
...
|*category*      |PARAMETER
|*description*   |Systems invoked through indirect ApiCall
|===

====== System Elements

Follows the same structure as System in ActiveSystems
...
|double           |Floating point type           |IEEE 754
|boolean          |Boolean type                  |true/false
|dateTime         |Date/Time                     |ISO 8601
|string           |Multi-language string         |BCP 47
|===
...
|GUID             |Uniqueness            |Ensures uniqueness within system
|ID               |Database Key          |Value exists only after DB storage
|DateTime         |ISO Format            |Complies with ISO 8601 format
|References       |Integrity             |Maintains referential integrity
...
|VR-008           |All ApiCall elements MUST have Name, Guid, and ApiDef properties
|VR-009           |All Arrow elements MUST have Name, Guid, Source, and Target properties
|===
...
|===
|*Rule*           |*Description*
|VR-030           |FlowGuid references in Work, Button, Lamp, Condition, and Action MUST point to existing Flow elements
...
*Note*: In the following examples, entity names are prefixed to GUIDs for better readability, but actual data should use GUIDs only
    ...
    "System": [
      {
        ...
        "Buttons": [
          {
            "Name": "Start Button",
            "Guid": "button-11111111-aaaa-bbbb-cccc-111111111111",
            "FlowGuid": "flow-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"
          },
          {
            "Name": "Stop Button", 
            "Guid": "button-22222222-aaaa-bbbb-cccc-222222222222",
            "FlowGuid": "flow-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"
          }
        ],
        "Lamps": [
          {
            "Name": "Status Lamp",
            "Guid": "lamp-11111111-dddd-eeee-ffff-111111111111",
            "FlowGuid": "flow-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"
          }
        ],
        "Conditions": [
          {
            "Name": "Part Present",
            "Guid": "condition-11111111-1111-2222-3333-111111111111",
            "FlowGuid": "flow-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"
          }
        ],
        "Actions": [
          {
            ...
            "Guid": "action-11111111-4444-5555-6666-111111111111",
            "FlowGuid": "flow-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"
          }
        ],
        "ApiCalls": [
    ...
    "System": [
      {
        ...
        "Flows": [
          {
            "Name": "Cell A Production Flow",
            "Guid": "cell-a-flow-aaaa-bbbb-cccc-dddd11111111"
          }
        ],
        "Works": [
          {
            ...
            "FlowGuid": "cell-a-flow-aaaa-bbbb-cccc-dddd11111111",
            "Period": 45.0
          }
        ],
        "Buttons": [
          {
            "Name": "Cell A Start",
            "Guid": "cell-a-btn-1111-2222-3333-444455556666",
            "FlowGuid": "cell-a-flow-aaaa-bbbb-cccc-dddd11111111"
          }
        ],
        "Lamps": [
          {
            "Name": "Cell A Status",
            "Guid": "cell-a-lamp-1111-2222-3333-444455556666",
            "FlowGuid": "cell-a-flow-aaaa-bbbb-cccc-dddd11111111"
          }
        ]
      },
      {
        ...
        "Flows": [
          {
            "Name": "Cell B Production Flow",
            "Guid": "cell-b-flow-bbbb-cccc-dddd-eeee22222222"
          }
        ],
        "Works": [
          {
            ...
            "FlowGuid": "cell-b-flow-bbbb-cccc-dddd-eeee22222222",
            "Period": 60.0
          }
        ],
        "Buttons": [
          {
            "Name": "Cell B Start",
            "Guid": "cell-b-btn-2222-3333-4444-555566667777",
            "FlowGuid": "cell-b-flow-bbbb-cccc-dddd-eeee22222222"
          }
        ],
        "Lamps": [
          {
            "Name": "Cell B Status",
            "Guid": "cell-b-lamp-2222-3333-4444-555566667777",
            "FlowGuid": "cell-b-flow-bbbb-cccc-dddd-eeee22222222"
          }
        ]
      },
      {
        ...
        "Guid": "quality-ctrl-3333-4444-5555-666677778888",
        "Flows": [
          {
            "Name": "Quality Check Flow",
            "Guid": "quality-flow-cccc-dddd-eeee-ffff33333333"
          }
        ],
        "Works": [
          {
            ...
            "FlowGuid": "quality-flow-cccc-dddd-eeee-ffff33333333"
          }
        ],
        "Conditions": [
          {
            "Name": "Quality Pass",
            "Guid": "quality-cond-3333-4444-5555-666677778888",
            "FlowGuid": "quality-flow-cccc-dddd-eeee-ffff33333333"
          }
        ],
        "Actions": [
          {
            "Name": "Mark Complete",
            "Guid": "quality-action-3333-4444-5555-666677778888",
            "FlowGuid": "quality-flow-cccc-dddd-eeee-ffff33333333"
          }
        ]
      }
