...
module CreateSampleWithHelloDsModule =
    let createHelloDS(): Project =
        ...
        // System에 UI 요소들 추가
        buttons    .Cast<BLCABase>() |> hdsSystem.AddEntities
        lamps      .Cast<BLCABase>() |> hdsSystem.AddEntities
        conditions .Cast<BLCABase>() |> hdsSystem.AddEntities
        actions    .Cast<BLCABase>() |> hdsSystem.AddEntities
