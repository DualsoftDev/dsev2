                ...
                | :? ApiDef as rt ->
                    ...
                    let apiDefId =
                        conn.Insert($"""INSERT INTO {Tn.ApiDef}
                                               (guid, parameter, name, isPush, topicIndex, isTopicOrigin, systemId)
                                        VALUES (@Guid, @Parameter{dbApi.DapperJsonB}, @Name, @IsPush, @TopicIndex, @IsTopicOrigin, @SystemId);""", orm, tr)
