...
module AasSemantics =
    let map : Dictionary<string, string> =
        [
            ...
            ("TxGuid",           "https://dualsoft.com/aas/apiDef/TxGuid")
            ("RxGuid",           "https://dualsoft.com/aas/apiDef/RxGuid")
...
module JsonExtensionModule =
    ...
    type System.Text.Json.Nodes.JsonObject with // AddProperties<'T>, AddValues, Set, SetKeys, SetModelType, SetSemantic, SetTypedValue<'T>, SetValues, ToSjSMC, TrySetProperty<'T>
